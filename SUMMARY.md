...
* [Use as a go package](use-as-a-go-package.md)
* [Github](https://github.com/TomWright/dasel)
* [Playground](https://dasel.tomwright.me)
...
* [Introduction](selectors/introduction.md)
* [Property](selectors/property.md)
* [Keys and indexes](selectors/keys-and-indexes.md)
* [Index](selectors/index.md)
* [Next Available Index](selectors/next-available-index.md)
* [All indexes](selectors/all-indexes.md)
* [Dynamic](selectors/dynamic.md)
* [Search](selectors/search.md)
* [Search Optional](selectors/search-1.md)
* [Length](selectors/length.md)
* [Type](selectors/type.md)

## Notes

* [File formatting and ordering](notes/file-formatting-and-ordering.md)
